  ...
  return <div className="min-h-screen bg-[#070707] text-white">
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#070707]/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 lg:px-8">
        ...
        <div className="flex items-center gap-2"><Link href="/ai" className="rounded-full border border-[#f5c542]/20 bg-[#f5c542]/5 px-3 py-2 text-xs font-bold text-[#f5c542] transition hover:bg-[#f5c542]/10">FORGE AI</Link><WalletButton /></div>
      </div>
      <ForgeTicker />
    </header>
    {children}
